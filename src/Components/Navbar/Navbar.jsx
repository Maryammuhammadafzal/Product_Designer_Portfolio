...
const Navbar = () => {
  return (
    <nav className='w-full h-[70px] flex justify-between shadow-md  items-center bg-white md:p-0 px-2'>
        <div className="logo md:w-[20%] h-[40px] items-center flex justify-center ">
                <h3>Logo</h3>
        </div>
        <div className="tabs w-[40%] h-[40px] items-center md:flex justify-center hidden">
        ...
        <div className="button md:w-[20%] h-[40px] items-center flex justify-center ">
